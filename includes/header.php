...
<body>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">      
     <div class="col-md-3"><h3>Manoj Garments</h3> </div>
      ...
      <li class="dropdown" id="navSetting">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="glyphicon glyphicon-user"></i>Retailers<span class="caret"></span></a>
          <ul class="dropdown-menu">            
            <li id="topNavSetting"><a href="retailer.php"> <i class="glyphicon glyphicon-plus"></i>Add</a></li>            
            <li id="topNavLogout"><a href="manageRetailer.php"> <i class="glyphicon glyphicon-log-out"></i> Manage</a></li>            
          </ul>
        </li> 
